        ...
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-400">
              ...
              <li>
                <a href="/" onClick={handleScrollTop} className="hover:text-emerald-400 transition-colors cursor-pointer">
                  Home
                </a>
              </li>
              
              <li>
                <Link to={user ? "/dashboard" : "/auth"} className="hover:text-emerald-400 transition-colors">
                  Donate Food
                </Link>
              </li>
              <li>
